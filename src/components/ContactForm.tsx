...
export default function ContactForm() {
  ...
  const [newsStatus, setNewsStatus] = useState<'idle' | 'success' | 'exists' | 'invalid'>('idle');
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Section Title */}
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-16" id="contact-title-block">
          ...
          <p className="text-slate-600 dark:text-slate-400 font-light text-base sm:text-lg">
            Ready to scale your digital services globally? Contact our engineering group today. We respond with formal scopes within 24 hours.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-12 gap-12" id="contact-grid">
          ...
          <div className="lg:col-span-5 space-y-8" id="contact-details-column">
            ...
            <div className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-3xl p-6 sm:p-8 space-y-6 shadow-sm">
              ...
              <p className="text-xs sm:text-sm text-slate-500 dark:text-slate-400 font-light">
                Our remote engineering networks operate continuously to ensure seamless support across all standard business timezones.
              </p>
              ...
              <div className="space-y-4 pt-4 border-t border-slate-200/60 dark:border-slate-800">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <span className="block text-xs font-semibold text-slate-500 uppercase tracking-wider">Corporate Mailbox</span>
                    <a href="mailto:solutions@sreevika.com" className="text-sm font-semibold text-slate-900 dark:text-white hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+918045678912" className="text-sm font-semibold text-slate-900 dark:text-white hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                      +91 (80) 4567 8912
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <span className="block text-xs font-semibold text-slate-500 uppercase tracking-wider">Corporate Headquarters</span>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <span className="block text-xs font-semibold text-slate-500 uppercase tracking-wider">Global Reach</span>
                    <p className="text-sm font-semibold text-slate-900 dark:text-white">
                      Delivering premium IT services to clients across USA, Europe, and Asia-Pacific.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-gradient-to-br from-blue-900 to-blue-950 text-white rounded-3xl p-6 sm:p-8 space-y-6 shadow-xl relative overflow-hidden" id="newsletter-form-container">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-blue-200/80 leading-relaxed font-light">
                  Subscribe to our quarterly engineering bulletin. Get technical deep-dives into microservices, database normalization, and system scalability.
                </p>
              </div>
              ...
              <form onSubmit={handleNewsletterSubmit} className="space-y-2.5" id="newsletter-form">
                ...
                <AnimatePresence mode="wait">
                  {newsStatus === 'success' && (
                    <motion.div initial={{ opacity: 0, y: 5 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0 }} className="text-emerald-400 text-[11px] font-medium flex items-center gap-1.5 pt-1">
                      <CheckCircle className="w-3.5 h-3.5 shrink-0" />
                      <span>Successfully subscribed to Sreevika Tech bulletins!</span>
                    </motion.div>
                  )}
                  {newsStatus === 'exists' && (
                    <motion.div initial={{ opacity: 0, y: 5 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0 }} className="text-amber-400 text-[11px] font-medium flex items-center gap-1.5 pt-1">
                      <AlertCircle className="w-3.5 h-3.5 shrink-0" />
                      <span>This email is already in our subscription log.</span>
                    </motion.div>
                  )}
                  {newsStatus === 'invalid' && (
                    <motion.div initial={{ opacity: 0, y: 5 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0 }} className="text-rose-400 text-[11px] font-medium flex items-center gap-1.5 pt-1">
                      <AlertCircle className="w-3.5 h-3.5 shrink-0" />
          ...
          <div className="lg:col-span-7" id="contact-form-column">
            <div className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-3xl p-6 sm:p-8 shadow-sm">
              ...
              <form onSubmit={handleContactSubmit} className="space-y-5" id="inquiry-form">
                ...
                <div className="grid sm:grid-cols-2 gap-5">
                  ...
                  <div className="space-y-1.5">
                    ...
                    >
                      ...
                      <option value="Agile Product Consulting">Agile Product Consulting</option>
                    </select>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-1.5 text-xs text-slate-400 dark:text-slate-500 font-light pt-1">
                  ...
                  <span>Sreevika Tech is fully GDPR compliant. Information is processed securely.</span>
                </div>
                ...
                <AnimatePresence mode="wait">
                  {submitStatus === 'success' && (
                    ...
                    >
                      ...
                      <div>
                        <span className="block font-semibold">Inquiry Logs Successfully Filed!</span>
                        <span className="block text-xs font-light mt-0.5">Thank you, {name}. Sreevika Tech's lead systems architect has been routed this request. Track conversion live on the HUD!</span>
                      </div>
                    </motion.div>
                  )}
                  ...
                  {submitStatus === 'error' && (
                    ...
                    >
                      ...
                      <div>
                        <span className="block font-semibold">Unable to Process Inquiry</span>
                        <span className="block text-xs font-light mt-0.5">Please fill out all required fields (*) with valid corporate contact credentials.</span>
                      </div>
                    </motion.div>
                  )}
                </AnimatePresence>
