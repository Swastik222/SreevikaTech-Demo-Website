      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-slate-600 dark:text-slate-400 font-light text-base sm:text-lg">
            See how Sreevika Tech helps technical executives, founders, and
            compliance managers architect secure, robust applications worldwide.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8" id="testimonials-grid">
          {TESTIMONIALS.map((t, index) => (
            <motion.div
              ...
              key={t.id}
              className="relative flex flex-col justify-between bg-transparent p-6 md:p-8 rounded-2xl border border-slate-100 dark:border-slate-700/50 hover:shadow-lg transition-all duration-300"
            ...
            >
              ...
              {/* Author Info */}
              <div
                className="flex items-center gap-4 mt-8 pt-4 border-t border-slate-200/50 dark:border-slate-700/50"
                id="author-info"
              >
        ...
        <div
          className="mt-20 pt-10 border-t border-slate-100 dark:border-slate-800 grid grid-cols-2 md:grid-cols-4 gap-8 text-center"
          id="global-trust-badges"
        >
          {[
            {
              icon: <ShieldCheck className="w-6 h-6 text-blue-500 mx-auto" />,
              label: "SOC2 Security Ready",
              sub: "Rigid encryption",
            },
            {
              icon: <Award className="w-6 h-6 text-blue-500 mx-auto" />,
              label: "ISO Compliant Core",
              sub: "Standardized delivery",
            },
            {
              icon: <ThumbsUp className="w-6 h-6 text-blue-500 mx-auto" />,
              label: "99% CSAT Rating",
              sub: "Verified by executives",
            },
            {
              icon: <Star className="w-6 h-6 text-blue-500 mx-auto" />,
            ...
            <div key={idx} className="space-y-2">
              ...
              <div>
                ...
                <span className="text-[10px] sm:text-xs text-slate-500 dark:text-slate-500 font-light">
                  {badge.sub}
                </span>
              </div>
            </div>
