...
export default function Footer() {
  ...
  return (
    <footer
      className="bg-slate-900 text-slate-400 dark:bg-slate-900 dark:border-t dark:border-slate-800 transition-colors duration-200"
      id="global-footer"
    >
      {/* Top Footer Block */}
        ...
        >
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <p className="text-sm font-light text-slate-400 leading-relaxed max-w-sm">
              Sreevika Tech provides premium software systems, cloud operations
              architectures, and custom AI retrieval pipelines to organizations
              globally. Ensuring a seamless user experience across all devices.
            </p>

            {/* Social Icons Bar */}
            <div
              className="flex items-center gap-3 pt-2"
              id="footer-social-bar"
            >
              {[
                {
          ...
          <div className="lg:col-span-4 space-y-4">
            ...
            <ul className="space-y-3.5 text-sm font-light">
              ...
              <li className="flex items-start gap-3">
                ...
                <span>
                  Tech Park Alpha, Outer Ring Road, Bengaluru, Karnataka, India
                  - 560103
                </span>
              </li>
            </ul>
      ...
      <div className="bg-slate-900 text-xs py-6 border-t border-slate-800/40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="text-slate-500 font-light text-center sm:text-left">
            <span>
              © 2026 <strong>Sreevika Tech</strong>. All rights reserved
              globally.
            </span>
          </div>
