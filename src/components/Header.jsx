...
export default function Header({ onToggleAnalytics, isAnalyticsOpen }) {
  ...
  const toggleTheme = () => {
    ...
    trackEvent(
      "theme_toggle",
      `Switched theme to ${nextMode ? "Dark" : "Light"}`,
    );
  };
  ...
  return (
    <header
      className="fixed top-0 left-0 right-0 z-40 h-16 bg-white/40 dark:bg-slate-900/40 backdrop-blur-xl border-b border-white/50 dark:border-white/10 transition-colors duration-200 dark:shadow-xl"
      id="header-container"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full">
        <div className="flex items-center justify-between h-full">
          ...
          >
            {/* Custom Elegant Logo Container */}
            <div
              className="relative w-10 h-10 flex items-center justify-center group-hover:scale-105 transition-transform duration-500"
              id="infinity-logo-wrapper"
            >
              <div className="absolute inset-0 bg-gradient-to-tr from-blue-600 to-emerald-400 rounded-xl blur-[8px] opacity-40 group-hover:opacity-80 transition-opacity duration-500"></div>
              <div className="relative w-full h-full bg-white/40 dark:bg-slate-900/50 backdrop-blur-md rounded-xl border border-white/50 dark:border-white/20 flex items-center justify-center overflow-hidden shadow-lg">
                <div className="absolute inset-0 bg-gradient-to-tr from-blue-500/20 to-transparent"></div>
                <svg
                  viewBox="0 0 24 24"
                  className="w-6 h-6 text-blue-600 dark:text-blue-400 z-10"
                  fill="currentColor"
            ...
            <div className="flex flex-col justify-center ml-1">
              <span className="font-display text-2xl tracking-tighter leading-none flex items-center">
                <span className="font-semibold bg-gradient-to-r from-blue-600 via-indigo-600 to-emerald-500 dark:from-blue-400 dark:via-indigo-400 dark:to-emerald-400 bg-clip-text text-transparent">
                  Sreevika
                </span>
                <span className="font-light text-slate-700 dark:text-slate-300 ml-[1px]">
                  Tech
                </span>
                <span className="w-1.5 h-1.5 rounded-full bg-emerald-500 ml-1.5 mb-2 shadow-[0_0_8px_rgba(16,185,129,0.8)]"></span>
              </span>
              <div className="flex items-center gap-1.5 mt-1 opacity-90">
                ...
                <span className="text-[9px] font-sans tracking-[0.25em] text-slate-500 dark:text-slate-400 font-medium uppercase leading-none mt-0.5">
                  Global IT Service
                </span>
              </div>
            </div>
      ...
      {isOpen && (
        <div
          className="md:hidden border-t border-slate-100 dark:border-slate-800 bg-white/95 dark:bg-slate-900/95 backdrop-blur-md absolute top-20 left-0 right-0 py-4 px-6 shadow-xl space-y-3"
